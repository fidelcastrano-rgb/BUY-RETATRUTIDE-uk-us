...
import { Calendar, User, ArrowRight, ChevronRight, BookOpen, Search } from 'lucide-react';
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-none shrink-0 border-r border-[#CBD5E1]/10 pr-4">
            {categories.map((cat) => (
              <button
                ...
                className={`text-xs font-bold font-heading uppercase tracking-widest px-4 py-2.5 rounded-xl shrink-0 transition-all ${
